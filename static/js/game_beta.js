...
var update = function (modifier) {
	...
	for (var h=0;h<CONNECTED_PLAYER_OBJECTS.length;h++) {
				...
				if (CONNECTED_PLAYER_OBJECTS[h].fireBallsActive[fb].y > canvas.height || CONNECTED_PLAYER_OBJECTS[h].fireBallsActive[fb].y < 0 ) {
					hero.fireBallsActive.splice(fb,1);//remove the fireball
				}
				if (CONNECTED_PLAYER_OBJECTS[h].fireBallsActive[fb].x > canvas.width || CONNECTED_PLAYER_OBJECTS[h].fireBallsActive[fb].x < 0) {
